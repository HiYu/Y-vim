...
hi CursorLine  cterm=NONE ctermbg=blue ctermbg=blue ctermfg=white
...
Plugin 'vim-airline/vim-airline' "status 美化
...
let g:file_copyright_name = "Frank"
let g:file_copyright_email = "zhaoyyuu@gmail.com"
